...
var pkg_wrap_os = &gowrap.Pkg{
	Exports: map[string]reflect.Value{
		...
		"Args":              reflect.ValueOf(wrap_os.Args),
		...
		"ErrClosed":         reflect.ValueOf(wrap_os.ErrClosed),
		"ErrExist":          reflect.ValueOf(wrap_os.ErrExist),
		"ErrInvalid":        reflect.ValueOf(wrap_os.ErrInvalid),
		"ErrNotExist":       reflect.ValueOf(wrap_os.ErrNotExist),
		"ErrPermission":     reflect.ValueOf(wrap_os.ErrPermission),
		...
		"Interrupt":         reflect.ValueOf(wrap_os.Interrupt),
		...
		"Kill":              reflect.ValueOf(wrap_os.Kill),
		...
		"Stderr":            reflect.ValueOf(wrap_os.Stderr),
		"Stdin":             reflect.ValueOf(wrap_os.Stdin),
		"Stdout":            reflect.ValueOf(wrap_os.Stdout),
