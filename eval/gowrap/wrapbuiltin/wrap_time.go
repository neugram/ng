...
var wrap_time = &gowrap.Pkg{
	Exports: map[string]reflect.Value{
		...
		"Duration":        reflect.ValueOf(reflect.TypeOf(time.Duration(0))),
		...
		"Location":        reflect.ValueOf(reflect.TypeOf(time.Location{})),
		...
		"Month":           reflect.ValueOf(reflect.TypeOf(time.Month(0))),
		...
		"ParseError":      reflect.ValueOf(reflect.TypeOf(time.ParseError{})),
		...
		"Ticker":          reflect.ValueOf(reflect.TypeOf(time.Ticker{})),
		"Time":            reflect.ValueOf(reflect.TypeOf(time.Time{})),
		"Timer":           reflect.ValueOf(reflect.TypeOf(time.Timer{})),
		...
		"Weekday":         reflect.ValueOf(reflect.TypeOf(time.Weekday(0))),
	},
}
