...
var pkg_wrap_io = &gowrap.Pkg{
	Exports: map[string]reflect.Value{
		...
		"EOF":              reflect.ValueOf(wrap_io.EOF),
		"ErrClosedPipe":    reflect.ValueOf(wrap_io.ErrClosedPipe),
		"ErrNoProgress":    reflect.ValueOf(wrap_io.ErrNoProgress),
		"ErrShortBuffer":   reflect.ValueOf(wrap_io.ErrShortBuffer),
		"ErrShortWrite":    reflect.ValueOf(wrap_io.ErrShortWrite),
		"ErrUnexpectedEOF": reflect.ValueOf(wrap_io.ErrUnexpectedEOF),
