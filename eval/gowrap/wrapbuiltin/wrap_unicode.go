...
var wrap_unicode = &gowrap.Pkg{
	Exports: map[string]reflect.Value{
		...
		"CaseRange":              reflect.ValueOf(reflect.TypeOf(unicode.CaseRange{})),
		...
		"Range16":                      reflect.ValueOf(reflect.TypeOf(unicode.Range16{})),
		"Range32":                      reflect.ValueOf(reflect.TypeOf(unicode.Range32{})),
		"RangeTable":                   reflect.ValueOf(reflect.TypeOf(unicode.RangeTable{})),
		...
		"SpecialCase":                  reflect.ValueOf(reflect.TypeOf(unicode.SpecialCase(nil))),
