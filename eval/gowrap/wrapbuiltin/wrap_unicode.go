...
var wrap_unicode = &gowrap.Pkg{
	Exports: map[string]reflect.Value{
		...
		"CaseRange":              reflect.ValueOf(unicode.CaseRange{}),
		...
		"Range16":                      reflect.ValueOf(unicode.Range16{}),
		"Range32":                      reflect.ValueOf(unicode.Range32{}),
		"RangeTable":                   reflect.ValueOf(unicode.RangeTable{}),
